    ...
    public class VolunteersController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery]FilterParemetersVolunteers filter)
        {
            _logger.LogInformation("{info}",
                "Endpoint Volunteers/api/v2 GetAll was called");
        ...
        {
            _logger.LogInformation("{info}",
                $"Endpoint Volunteers/api/v2 GetById({id}) was called");
        ...
        public async Task<IActionResult> Create([FromBody]VolunteerDTO volunteerDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint Volunteers/api/v2 [POST] was called", userId, token);
            ...
            return Created("api/v2/volunteers/" + volunteer.ID, volunteerDTO);
        }
        ...
        public async Task<IActionResult> Edit([FromQuery]int id, [FromBody]VolunteerDTO volunteerDTO)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Volunteers/api/v2 [PUT] was called", userId, token);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Volunteers/api/v2 [DELETE] was called",
                userId, token);
