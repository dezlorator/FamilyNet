    ...
    public class QuestsController : ControllerBase
    {
                                                    ...
                                                    [FromQuery]string forSearch)
        {
            _logger.LogInformation("{info}",
                "Endpoint Quests/api/v2 GetAll was called");
        ...
        {
            _logger.LogInformation("{info}",
                 $"Endpoint Quests/api/v2 GetById({id}) was called");
        ...
        public async Task<IActionResult> Edit(int id, [FromBody]QuestDTO questDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint Quests/api/v2 [PUT] was called", userId, token);
        ...
        public async Task<IActionResult> Create([FromBody]QuestDTO questDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint Quests/api/v2 [POST] was called", userId, token);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
               "Endpoint Quests/api/v2 [DELETE] was called", userId, token);
