    ...
    public class ChildrenHouseController : ControllerBase
    {
                                   ...
                                   [FromQuery]int page)
        {
            _logger.LogInformation("{info}",
                "Endpoint ChildrenHouses/api/v2 GetAll was called");
        ...
        {
            _logger.LogInformation("{info}",
                $"Endpoint ChildrenHouses/api/v2 GetById({id}) was called");
        ...
        public async Task<IActionResult> Create([FromBody]ChildrenHouseDTO childrenHousesDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint ChildrenHouses/api/v2 [POST] was called",
                userId, token);
            ...
            return Created("api/v2/childrenHouse/" + childrenHouse.ID, childrenHousesDTO);
        }
        ...
        public async Task<IActionResult> Edit([FromRoute]int id, [FromBody]ChildrenHouseDTO childrenHouseDTO)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint ChildrenHouses/api/v2 [PUT] was called", userId, token);
        ...
        public async Task<IActionResult> Delete([FromRoute]int id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint ChildrenHouse/api/v2 [DELETE] was called",
                userId, token);
