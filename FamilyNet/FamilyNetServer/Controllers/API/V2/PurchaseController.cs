    ...
    public class PurchaseController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            _logger.LogInformation("{info}{token}{userId}",
                "Endpoint Purchase/api/v2 GetAll was called", token, userIdentity);
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            _logger.LogInformation("{info}{token}{userId}",
                 $"Endpoint Purchase/api/v2 GetById({id}) was called",
                 token, userIdentity);
        ...
        public async Task<IActionResult> Create([FromBody]PurchaseDTO purchaseDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint Purchase/api/v2 [POST] was called", userIdentity, token);
        ...
        public async Task<IActionResult> Edit([FromRoute]int id, [FromBody]PurchaseDTO purchaseDTO)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Purchase/api/v2 [PUT] was called", userIdentity, token);
        ...
        public async Task<IActionResult> Delete([FromRoute]int id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
               "Endpoint Purchase/api/v2 [DELETE] was called", userId, token);
