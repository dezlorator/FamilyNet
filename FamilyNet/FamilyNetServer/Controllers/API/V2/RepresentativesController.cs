    ...
    public class RepresentativesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllAsync([FromQuery] FilterParametersRepresentatives filter)
        {
            _logger.LogInformation("{info}",
                "Endpoint Representatives/api/v2 GetAll was called");
        ...
        {
            _logger.LogInformation("{info}",
                $"Endpoint Representatives/api/v2 GetById({id}) was called");
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Create([FromBody]RepresentativeDTO representativeDTO)
        {
            ...
            _logger.LogInformation("{info} {userId} {token}",
                "Endpoint Representatives/api/v2 [POST] was called", userId, token);
            ...
            return Created("api/v2/representatives/" + representative.ID, representativeDTO);
        }
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Edit(int id, [FromBody]RepresentativeDTO representativeDTO)
        {
            var userId = _identityExtractor.GetId(User);
            var token = _identityExtractor.GetSignature(HttpContext);

            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Representatives/api/v2 [PUT] was called", userId, token);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
               "Endpoint Representatives/api/v2 [DELETE] was called", userId, token);
