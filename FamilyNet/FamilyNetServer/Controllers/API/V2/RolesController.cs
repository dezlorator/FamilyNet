    ...
    public class RolesController : ControllerBase
    {
        ...
        public IActionResult GetAllAsync()
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Roles/api/v2 [GET] was called", userId, token);
        ...
        public async Task<IActionResult> CreateAsync([FromBody]RoleDTO roleDTO)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Roles/api/v2 [POST] was called", userId, token);
            ...
            if (roleDTO != null)
            {
                ...
                return Created("api/v2/roles/", roleDTO);
            }
        ...
        public async Task<IActionResult> DeleteAsync(string id)
        {
            ...
            _logger.LogInformation("{info}{userId}{token}",
                "Endpoint Roles/api/v2 [DELETE] was called", userId, token);
