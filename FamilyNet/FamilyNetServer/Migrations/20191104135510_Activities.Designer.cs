...
namespace FamilyNetServer.Migrations
{
    ...
    [Migration("20191104135510_Activities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyNetServer.Models.Award", b =>
                {
                    ...
                    b.Property<int?>("ChildrenActivityID");
            ...
            modelBuilder.Entity("FamilyNetServer.Models.ChildrenActivity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FamilyNetServer.Models.Award", b =>
                {
                    b.HasOne("FamilyNetServer.Models.ChildrenActivity")
                        .WithMany("Awards")
                        .HasForeignKey("ChildrenActivityID");
                });
            ...
            modelBuilder.Entity("FamilyNetServer.Models.ChildrenActivity", b =>
                {
                    b.HasOne("FamilyNetServer.Models.Orphan", "Child")
                        .WithMany()
